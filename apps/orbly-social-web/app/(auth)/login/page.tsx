  ...
  if (view !== "login") {
    return (
      <div className="w-full max-w-[440px] auth-animate-in">
        ...
        {view === "forgot-sent" ? (
          <div className="space-y-4 auth-animate-in">
          ...
          <form onSubmit={submitForgot} className="space-y-4 auth-animate-in">
            <AuthField
              id={forgotEmailId}
              label="E-posta"
              type="email"
          ...
          <form onSubmit={submitReset} className="space-y-4 auth-animate-in">
            <AuthField
              id={newPasswordId}
              label="Yeni şifre"
